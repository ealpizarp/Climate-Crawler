...
paisesCtrl.getEstaciones_busqueda = (req ,res) => {
    
    try {
        
        let results_array = [];
        const query = 'select * from STATION_MAX_VAR where  STATION_MAX_VAR.country ='+"'"+ req.params.pais+"'"+'';
        ...
        conn.query(query, function (error, results, fields) {
            ...
            const query = 'select * from STATION_MIN_VAR where  STATION_MIN_VAR.country ='+"'"+ req.params.pais+"'"+'';
            conn.query(query, function (error, results, fields) {
...
paisesCtrl.getmax_min_var_busqueda = (req ,res) => {
    
    try {
        
        let results_array = [];
        const query = 'select * from MAX_YEAR_VAR where  MAX_YEAR_VAR.country ='+"'"+ req.params.pais+"'"+'';
        ...
        conn.query(query, function (error, results, fields) {
            ...
            const query = 'select * from MIN_YEAR_VAR where  MIN_YEAR_VAR.country = '+"'"+ req.params.pais+"'"+'';
            conn.query(query, function (error, results, fields) {
