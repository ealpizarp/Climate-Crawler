...
sqoop export --connect jdbc:mysql://34.66.197.163:3306/DB2_PR2 --username admin --password adminpass --table MAX_AVG_COUNTRY_TEMPS --columns "country, temperature" --export-dir /MAX_AVG_COUNTRY_TEMPS  --fields-terminated-by '\0073';
:: Job MIN_AVG_COUNTRY_TEMPS
sqoop export --connect jdbc:mysql://34.66.197.163:3306/DB2_PR2 --username admin --password adminpass --table MIN_AVG_COUNTRY_TEMPS --columns "country, temperature" --export-dir /MIN_AVG_COUNTRY_TEMPS  --fields-terminated-by '\0073';
